...
<body background="../Web/asserts/images/2.jpg"style="background-repeat:no-repeat ;background-size:100% 100%;background-attachment:fixed;">
    <?php
        session_start();
        // 如果已经登录了，直接跳转至用户界面
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li><a class="btn-lg" href="admin/index.php">Admin</a></li>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Sign in to USER's account</h3>
